...
MySQL - 5.1.73-community : Database - springbootjpaonetomany
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`springbootjpaonetomany` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `springbootjpaonetomany`;
